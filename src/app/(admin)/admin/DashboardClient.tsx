...
export function DashboardClient({ initialData, companyName }: DashboardClientProps) {
  ...
  useEffect(() => {
    ...
    // Ouvir mudanças na tabela reservations
    ...
    // Ouvir mudanças na tabela excursions
    const excursionsChannel = supabase
      .channel("dashboard_excursions")
      .on(
        "postgres_changes",
    ...
    // Ouvir mudanças na tabela profiles
    ...
    return () => {
      ...
      supabase.removeChannel(excursionsChannel);
  ...
  const kpis = [
    {
      ...
      value: data.publishedExcursions,
      sub: `${data.totalExcursions} total`,
      color: "text-primary",
    ...
    },
    {
      ...
      sub: `${data.totalReservations} total`,
      color: "text-warning",
    ...
    },
    {
      ...
      value: data.approvedReservations,
      sub: "confirmadas",
      color: "text-success",
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-on-surface-variant">
            Visão geral de {companyName} — Atualizado em tempo real
          </p>
        </div>
        <Link
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        ...
        <div className="lg:col-span-3 bg-surface-container-lowest rounded-2xl shadow-sm overflow-hidden">
          ...
          <div className="divide-y divide-outline-variant/20">
            {data.recentExcursions && data.recentExcursions.length > 0 ? (
              data.recentExcursions.map((exc) => {
