...
export function MotoristaBottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 w-full z-50 bg-white/80 backdrop-blur-lg shadow-[0_-8px_30px_rgb(0,0,0,0.06)] border-t border-slate-100">
      <div className="max-w-4xl mx-auto flex justify-around items-center px-4 pb-6 pt-3">
        {/* Viagens */}
        <Link
          href="/motorista"
          className={cn(
            "flex flex-col items-center justify-center rounded-2xl px-8 md:px-16 py-2 transition-colors active:scale-90 duration-150 ease-in-out",
            pathname === "/motorista"
