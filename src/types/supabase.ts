  ...
  public: {
    Tables: {
      ...
      excursion_occupancy: {
        ...
        Relationships: [
          {
            foreignKeyName: "excursion_occupancy_excursion_id_fkey"
      ...
      excursion_reports: {
        ...
        Relationships: [
          {
            foreignKeyName: "excursion_reports_driver_id_fkey"
            columns: ["driver_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "excursion_reports_excursion_id_fkey"
            columns: ["excursion_id"]
            isOneToOne: false
            referencedRelation: "excursions"
            referencedColumns: ["id"]
      ...
      global_settings: {
        Row: {
          ...
          driver_checklist_items: Json | null
          driver_contact_numbers: Json | null
    ...
    Functions: {
      allocate_seats_for_reservation:
        | {
            Args: {
              p_excursion_id: string
              p_prefer_together: boolean
      ...
      confirm_user_email: {
        Args: { hmac_token: string; user_email: string; user_uid: string }
        Returns: boolean
      }
      expire_pending_reservations: { Args: never; Returns: undefined }
      generate_short_code: { Args: never; Returns: string }
      get_email_secret: { Args: never; Returns: string }
      get_occupied_seat_codes: {
        Args: { p_excursion_id: string }
        Returns: string[]
      }
      get_occupied_seats: {
        Args: { exc_ids: string[] }
